...
#' \code{rmatrix_int} generates an integer matrix, by changing the storage mode of a matrix
#' generated by \code{rmatrix}. All its arguments are directly passed to \code{rmatrix}.
#' 
#' @rdname rmatrix
#' @export
rmatrix_int <- function(...){
    x <- rmatrix(...)
